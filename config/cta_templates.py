...
CTA_TEMPLATES = [
    'Пишите прямо здесь в комментариях/чат группы, что хотите заказать — я сразу отвечу и оформлю со скидкой! 💬',
    'Хотите заказать или подсказать по выбору? Пишите мне в ЛС или прямо в чат группы 📩',
    'Заказывайте на сайте → {url} или пишите прямо в комментариях к посту 🛒',
    'Напишите "{keyword}" прямо здесь в комментариях — отвечу каждому и сделаю отличные условия 👇',
    'Кто хочет попробовать {product}? Пишите в чат группы — подберем лучшее решение 📲',
]
