...
- ОБЯЗАТЕЛЬНО разбей текст на 3-5 абзацев, каждый по 2-4 предложения. Между абзацами ставь пустую строку (двойной перенос строки). НИКАКОГО сплошного текста без пропусков!
